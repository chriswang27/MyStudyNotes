...
- The dropped neurons’ outputs are set to **zero**. The remaining neurons are **scaled up** (usually by `1 / (1 - dropout_rate)`) to maintain the expected output magnitude.

- Encourages **redundancy** and **robustness**.

- Forces the network to **not overfit** to specific neurons.
